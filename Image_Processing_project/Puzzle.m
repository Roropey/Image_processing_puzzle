...
[imagesCrop,count] = extractPieces(shuffled_image);
[imageAligned, Rfound] = aligned_pieces(imagesCrop,count);
figure; imshow(imageAligned.piece(1).im)
%PuzzledImage = load("piece_extrait_rgb_90.mat");
y = image_reconstruct(imageAligned, nbrPieces,1,Rfound);
